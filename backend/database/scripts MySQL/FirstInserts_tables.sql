...
-- Insérer des actions pour les clients
-- (Ajoutez des enregistrements dans les tables emprunter, commenter, favoris et partager)
...
INSERT INTO emprunter (mail_Clients, id_ebook, debut_emprunt, fin_emprunt, stock_emprunt) VALUES
    ('client1@email.com', 1, '2023-05-01', '2023-05-15', 1),
    ('client2@email.com', 2, '2023-05-02', '2023-05-16', 1),
    ('client3@email.com', 3, '2023-05-03', '2023-05-17', 1);

-- Ajouter des tuples dans la table commenter
INSERT INTO commenter (mail_Clients, id_ebook, note, commentaire, date_comment) VALUES
    ('client1@email.com', 1, 4, 'Super livre!', '2023-05-05'),
    ('client2@email.com', 2, 5, 'J\'ai adoré!', '2023-05-06'),
    ('client3@email.com', 3, 3, 'Pas mal du tout', '2023-05-07');
...
INSERT INTO partager (mail_Clients, mail_Clients_dest, id_ebook, fin_partage) VALUES
    ('client1@email.com', 'client2@email.com', 1, '2023-12-21'),
    ('client2@email.com', 'client3@email.com', 2, '2023-10-27'),
    ('client3@email.com', 'client1@email.com', 3, '2023-09-29');

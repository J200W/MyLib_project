...
<template>
  ...
  <div id="tab-selector">
    <router-link className="tabs selected" to="/LogIn">Log In</router-link>
    <router-link className="tabs" to="/SignUp">Sign Up</router-link>
  </div>

  <form id="form-login" @submit="submitForm">
    <label className="form-label" htmlFor="username">Email Address</label>
    <input className="form-input" type="email" id="username" name="username" v-model="email" required>
    <label className="form-label" htmlFor="password">Password</label>
    <input className="form-input" type="password" id="password" name="password" v-model="password" required>
    <label className="form-label" htmlFor="admin">Adminstrator</label>
    <input className="form-checkbox" type="checkbox" id="admin" name="admin" v-model="admin"><br><br>
